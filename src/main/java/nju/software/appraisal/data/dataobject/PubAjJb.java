...
public class PubAjJb implements java.io.Serializable {
	 ...
	 * 
	 */
	private static final long serialVersionUID = -1668736366473734975L;
	...
	public PubAjJb(Integer ajxh, String ah, String ajmc, String ajxz,
			...
			Date tzsqrq, Date swhjdrq, Date yzqfrq, String slqk, String sslx,
			String sfgs, String fhcsyy, String gpyy, String sfzscq,
			String swlx, String modflag, String transflag, String psycy,
			String msajtjs, String msajtjsss, String shwdfxpg, String sfktsl,
			String pjsffdjfnr, String sfhj, String fxhjcs, String sftz,
			String sfdtpj, String sfxess) {
		super();
		this.ajxh = ajxh;
		this.ah = ah;
		this.ajmc = ajmc;
