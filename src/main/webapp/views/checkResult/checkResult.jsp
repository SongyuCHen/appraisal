        ...
        <div class="search_body">
            <form class="form-inline">
                <div class="form-group" style="margin-bottom: 20px">
                    ...
                    <label class="checkbox-inline" ng-repeat="c in checkItem">
                        <input type="checkbox" value="{{c.value}}" disabled="disabled" ng-checked="{{c.check}}"> {{c.name}}
                    </label>
                </div>
                <div class="search_line">
                    <div class="form-group" style="width: 100%">
                        <label for="property">评查依据:</label>
                        <input disabled="disabled" type="text" class="form-control" id="property" placeholder="{{checkEvid}}"style="width: 70%;margin-left: 5px">
                    </div>
                </div>
            </form>
        </div><!-- search_body -->
...
<div class="sm-modal" style="display: none" ng-controller="detailCtrl">
    <div class="sm-modal-title">已评查</div>
    <div class="sm-modal-content">
        <span ng-repeat="d in detail">{{d.name}}{{d.value}}</span>
        <!-- <hr style="border: 1px dashed rgb(192,192,192);width: 90%"> -->
    </div>
    <div class="sm-modal-footer">
        <div class="buttons">
            <button type="button" class="btn btn-default" onclick="show_detail()">详情</button>
            <button type="button" class="btn btn-primary" onclick="confirm1()">确定</button>
        </div>
    </div>
</div>
...
<script type="text/javascript" src="../../resources/js/checkResult/checkResult.js"></script>
